...
class Draggable2 extends React.Component {
    ...
    onDrag = (e) => {
        ...
        if (this.props.bounds === 'parent') {
            ...
            if (axis === 'x' && e.clientX !== 0) {
                distance = Math.min(parent.clientWidth - oldDistance, distance);
            }
            if (axis === 'y' && e.clientX !== 0) {
                distance = Math.min(parent.clientHeight - oldDistance, distance);
            }
        }
...
export default Draggable2; //其他做完后再实现